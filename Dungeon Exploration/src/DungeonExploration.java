        ...
        while (Can != 1) {
                ...
                if (easy){
                    ...
                    switch (CombatLoop.Ally) {
                        ...
                        case "Ria":
                            ...
                            break;
                        case "Tay":
                            System.out.println("Tay: Finally, we out!");
                            System.out.println("Tay: Well, I'm sure you're thankful for my help");
                            System.out.println("Tay: Chao");
                            System.out.println("https://cdn.discordapp.com/attachments/517575103043731459/955322225207160922/unknown.png");
                            break;
                        case "Acks":
                            System.out.println("Acks: Yo, we're finally outta' there!");
                            System.out.println("Acks: Oh, uh, sorry to ask but ya' got any money for food?");
                            System.out.println("Acks: Maybe we could hang-out after eating, you're up for a little"
                                    + " weight liftin'?");
            ...
            if (Maze[Location_X][Location_Y] == 19 && Options) {
                ...
                if (!Player.toLowerCase().equals("peggy")) {
                    if (!(Player.toLowerCase().equals("tay"))) {
                        ...
                        System.out.println("Peggy: Tay? Why are you in a place like this?");
                    ...
                    System.out.println("Tay: Huh? Well, if it isn't little miss Peggy");
                    System.out.println("Tay: Well, as we both know, my dancing is far superior to your voice");
                    System.out.println("Tay: Can I fight? Well, th-that's not relevant!");
                    Partner = true; CombatLoop.Ally = "Tay";
                }
            }
        ...
        if (Partner){
            ...
            switch (CombatLoop.Ally){
                ...
                case "Ria":
                    ...
                    break;
                case "Tay":
                    System.out.println("Tay, a show off dancer");
