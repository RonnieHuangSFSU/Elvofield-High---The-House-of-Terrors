...
class CombatLoop {
    ...
    public static String Ria(){
        ...
        if (AllyCondition == 0){
            if (turn == 3 && Enemy1.equals("Mad Scientist")){
                ...
                if (random1 <= 2){
                    if (!Player.equals("Ria")) {
                        System.out.println(Ally + " casts fire!");
                    }
                    else{
                        System.out.println(Ally + " casts ice!");
                    }
                    if (Enemy1HP > 0) {
                        int damage = AllyAk - Enemy1Df;
                        if (damage <= 0) {
    ...
    public static String UndeadWarrior(){
        ...
        else if (Enemy3Ak <= 13 && random3 >= 5 && !Enemy1.equals("Poltergeist of the Mansion")){
    ...
    public static String Enemy1Lose(){
        ...
        switch (Enemy1){
            ...
            case "Spider":
                ...
                break;
            case "Golem":
                System.out.println(Enemy1 + " returns to rocks!");
                if (Enemy2HP > 0){
    ...
    public static String System(){
        ...
        if(PlayerHP <= 0){
            switch (Ally){
                case "Peggy":
                    System.out.println(Player + "? Oh, if only I was stronger, I could've help you better");
                    System.out.println();
                    break;
                case "Tay":
                    System.out.println(Player + "? Get up! I need you to get me out of here!");
                    System.out.println();
                    break;
                case "Lance":
                    System.out.println(Player + "? N-no! Don't leave me n-now of all times!");
                    System.out.println();
                    break;
                case "Acks":
                    System.out.println(Player + "? What happened? No, don't die on me 'ere dammit!");
                    System.out.println();
                    break;
                case "Ria":
                    System.out.println(Player + "? Snap out of it! I need your help!");
                    System.out.println();
                    break;
                case "Melaina":
                    System.out.println(Player + "? Oh...don't leave me here alone...");
                    System.out.println();
                    break;
            }
    ...
    public static String LevelUp(){
        ...
        if (DungeonExploration.easy){
            ...
            System.out.println("HP increased by 7!");
            PlayerMx += 10;
